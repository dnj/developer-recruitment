...
class Travel extends Model
{
    ...
    public function isProtectedSpot($spot)
    {
        return $this->getOriginSpot()->id == $spot->id || (count($this->spots) - 1) == $spot->position;
    }

    public function isCancelAble($isDriver)
    {
        return $this->status == TravelStatus::SEARCHING_FOR_DRIVER || ($isDriver && $this->status == TravelStatus::RUNNING);
    }
}
